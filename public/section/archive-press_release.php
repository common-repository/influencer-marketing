                    ...
                    <div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                        ...
                        <div class="pr-content">
                            ...
                            <div class="pr-pagination">
                                <div class="pr-pre"><?php echo get_previous_posts_link("Previous", $post->max_num_pages); ?></div>
                                <div class="pr-next"><?php echo get_next_posts_link("Next", $post->max_num_pages) ?></div>
                            </div>
                        </div>
                        <div class="pr-content">
